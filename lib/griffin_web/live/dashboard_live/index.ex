defmodule GriffinWeb.DashboardLive.Index do
  ...
  @search_field_names ["location_id", "gem_type", "exchange_on_from", "exchange_on_to"]
  ...
  defp list_exchange_gems(socket, search_criteria, opts \\ []) do
    ...
    exchange_gems = Exchange.list_exchange_gems(socket.assigns.current_user, changeset, opts)
