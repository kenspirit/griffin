defmodule Mix.Tasks.Griffin.Gen.Live do
  @shortdoc "Generates Griffin LiveView, templates, and context for a resource"
  ...
  defp context_files(%Context{generate?: true} = context) do
    IO.puts("context to generate")
    Gen.Context.files_to_be_generated(context)
  end
  defp context_files(%Context{generate?: false}) do
    IO.puts("context NOT to generate")
    []
  end
  ...
  defp copy_new_files(%Context{} = context, binding, paths) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/griffin.gen.live", binding, files)
  ...
  defp live_route_instructions(schema) do
    [
      ...
      ~s|live "/#{schema.plural}/:id/show", #{inspect(schema.alias)}Live.Index, :show\n|,
    ]
  end
end
